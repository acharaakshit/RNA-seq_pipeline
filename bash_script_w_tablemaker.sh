...
eval "tablemaker -p 3 -q -W -G merged_brain.gtf -o ~/brain_output ~/RNA_nanopore.brain.C1R1_mapping_E94_minimap2_primary_no_read_less_than_80QC_genome_convert.sorted.bam"
eval "tablemaker -p 3 -q -W -G merged_liver.gtf -o ~/liver_output ~/RNA_nanopore.liver.C1R1_mapping_E94_minimap2_primary_no_read_less_than_80QC_genome_convert.sorted.bam"
